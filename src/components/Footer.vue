...
<template>
  ...
  <div class="relative mt-16">
    <svg class=" absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-deep-purple-accent-400" preserveAspectRatio="none"
      viewBox="0 0 1440 54">
      <path class="fill-indigo-800" fill="currentColor"
        ...
        <div class="md:max-w-md lg:col-span-2">
          ...
          <div class="mt-4 lg:max-w-sm">
            <p class="text-sm text-deep-purple-50">
              The Kenya Women and Children's Wellness Centre is the inaugural project of James R. Jordan Foundation (JRJFI). JRJFI was
              established in 2000 by Mrs. Deloris Jordan in honor of her late husband, James.
            </p>
            <p class="mt-4 text-sm text-deep-purple-50">
              JRJFI is dedicated to strengthening
              families, motivating youth and ensuring high quality academic opportunities for children in underserved communities.
            </p>
          </div>
        </div>

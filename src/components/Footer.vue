...
<template>
  ...
  <div class="relative mt-16">
    <svg class=" absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-deep-purple-accent-400" preserveAspectRatio="none"
      viewBox="0 0 1440 54">
      <path class="fill-red-800" fill="currentColor"
    ...
    <div class="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
        ...
        <div class="md:max-w-md lg:col-span-2">
          <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
            <img class="h-32 w-auto" src="/logo.png"
                    alt="Your Company">
          </a>
          <div class="mt-4 lg:max-w-sm">
            <p class="text-sm text-deep-purple-50">
              Mich Digital leverages world-class digital marketing expertise that is meticulously curated to business or
              organization's challenge at hand. Our strength lies in applying insight and creativity in a human element, powered by
              data analytics, market research and digital technology.
            </p>
            <p class="mt-4 text-sm text-deep-purple-50">
              We love data, we love numbers and we only care about delivering
              results.
            </p>
          </div>
        </div>

        <div class="sm:mt-36 grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
          <div>
      ...
      <div class="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
        ...
        <div class="flex items-center mt-4 space-x-4 sm:mt-0">
          ...
          <a href="https://www.instagram.com/michdigital/" target="_blank" class="tranform transition hover:scale-150 duration-700 text-black hover:text-red-800">
          ...
          <a href="https://www.facebook.com/MichDigital" target="_blank" class="tranform transition hover:scale-150 duration-700 text-black hover:text-red-800">
            <svg viewBox="0 0 24 24" fill="currentColor" class="h-5">
              <path

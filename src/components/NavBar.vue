...
<template>
  <div class="">
    <div class="relative shadow bg-white bg-transparent">
                  ...
                  <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                      ...
                      <div class="ml-4">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Get all of your questions answered in our forums or contact
                          support.</p>
                      </div>
                    </a>
                    ...
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                      ...
                      <div class="ml-4">
                        ...
                        <p class="mt-1 text-sm text-gray-500">See what meet-ups and other events we might be planning near
                          you.</p>
                      </div>
                    </a>

          ...
          <nav class="hidden space-x-10 md:flex">
            <div class="relative">
              ...
              <button @mouseover="whoWeAre=true, whatWeDo=false" type="button"
                class="hover:font-bold  transform transition hover:scale-95 duration-700 text-gray-500 group inline-flex items-center rounded-md  text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                aria-expanded="false">
              ...
              <div
                ...
                <div @mouseleave="whoWeAre=false" class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  <div class="relative grid gap-6 bg-gray-50 px-5 py-6 sm:gap-8 sm:p-8">
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 group transform transition hover:scale-105 duration-700 bg-gradient-to-l hover:from-blue-200 hover:to-red-50">
                      <i class=" fa-solid fa-clock-rotate-left text-red-800 fa-xl mt-3"></i>
                      <div class="ml-4">
                    ...
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 group transform transition hover:scale-105 duration-700 bg-gradient-to-l hover:from-blue-200 hover:to-red-50">
                      <i class="fa-solid fa-sitemap text-red-800 fa-xl mt-3"></i>
                      <div class="ml-4">
                    ...
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 group transform transition hover:scale-105 duration-700 bg-gradient-to-l hover:from-blue-200 hover:to-red-50">
                      <i class="fa-solid fa-chess text-red-800 fa-xl mt-3"></i>
                      <div class="ml-4">
                    ...
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 group transform transition hover:scale-105 duration-700 bg-gradient-to-l hover:from-blue-200 hover:to-red-50">
                      <i class="fa-solid fa-users text-red-800 fa-xl mt-3"></i>
                      <div class="ml-4">
                  ...
                  <div class="space-y-6 bg-gradient-to-r from-gray-50 to-red-100 px-5 py-5 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
                  </div>
                </div>
              </div>
              ...
              <div v-if="whatWeDo"
               class="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0">
                <div @mouseleave="whatWeDo=false" class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  <div class="relative grid gap-6 bg-gray-50 px-5 py-6 sm:gap-8 sm:p-8">
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 group transform transition hover:scale-105 duration-700 bg-gradient-to-l hover:from-blue-200 hover:to-red-50">
                      <i class="fa-solid fa-magnifying-glass-location text-red-800 fa-xl mt-3"></i>
                      <div class="ml-4">
                    ...
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 group transform transition hover:scale-105 duration-700 bg-gradient-to-l hover:from-blue-200 hover:to-red-50">
                      <i class="fa-solid fa-house-flag text-red-800 fa-xl mt-3"></i>
                      <div class="ml-4">
                    ...
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 group transform transition hover:scale-105 duration-700 bg-gradient-to-l hover:from-blue-200 hover:to-red-50">
                      <i class="fa-solid fa-chalkboard-user text-red-800 fa-xl mt-3"></i>
                      <div class="ml-4">
                    ...
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 group transform transition hover:scale-105 duration-700 bg-gradient-to-l hover:from-blue-200 hover:to-red-50">
                      <i class="fa-solid fa-person-breastfeeding text-red-800 fa-xl mt-3"></i>
                      <div class="ml-4">
                    ...
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 group transform transition hover:scale-105 duration-700 bg-gradient-to-l hover:from-blue-200 hover:to-red-50">
                      <i class="fa-solid fa-face-sad-tear text-red-800 fa-xl mt-3"></i>
                      <div class="ml-4">
                    ...
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 group transform transition hover:scale-105 duration-700 bg-gradient-to-l hover:from-blue-200 hover:to-red-50">
                      <i class="fa-solid fa-suitcase-medical text-red-800 fa-xl mt-3"></i>
                      <div class="ml-4">
                    ...
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 group transform transition hover:scale-105 duration-700 bg-gradient-to-l hover:from-blue-200 hover:to-red-50">
                      <i class="fa-solid fa-person-falling-burst text-red-800 fa-xl mt-3"></i>
                      <div class="ml-4">

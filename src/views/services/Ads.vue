        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div
            ...
            <img class="h-96 w-full flex-none rounded-2xl object-cover shadow-xl lg:aspect-square lg:h-auto lg:max-w-sm"
              src="/services/Ads.png"
              alt="">
            <div class="w-full flex-auto">
              <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">ADVERTISING</h2>
              <p class="mt-6 text-lg leading-8 text-gray-300">
                We have managed over 1500 Social Media and Google Marketing Campaigns with over 2 million+ leads
                for clients. We are confident in our experience to help you scale your Brand Awareness in terms of reach
                and followers, Relationships and Website Exposure (traffic)
              </p>

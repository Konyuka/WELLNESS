      ...
      <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div class="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
          ...
          <form class="pt-5 flex flex-col items-center w-full mb-4 md:flex-row md:px-16">
            <input placeholder="Sign Up for Our News Letters" required="" type="text"
            ...
            <a href="/"
              class="inline-flex items-center justify-center w-full h-12 px-6 font-semibold tracking-wide text-gray-900 transition duration-200 rounded shadow-md md:w-auto hover:text-deep-purple-900 bg-gray-100 hover:bg-black hover:text-white hover:bg-teal-accent-700 focus:shadow-outline focus:outline-none">
              Subscribe
            </a>
          </form>
    ...
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-10 mb-14">
      <div class="grid gap-8 row-gap-5 sm:row-gap-8 sm:grid-cols-2 lg:grid-cols-3">
        <div class="bg-gradient-to-l hover:from-blue-200 hover:to-red-50 hover:cursor-pointer transform translate hover:scale-90 duration-700 shadow-lg hover:shadow-xl p-10">
          ...
          <h6 class="mb-2 font-semibold leading-5">School Outreach Program</h6>

<template>
  <div class="">
    ...
    <!-- <div class="bg-gradient-to-l from-blue-200 to-indigo-50"> -->
      <div class="mx-auto max-w-7xl py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl divide-y-2 divide-gray-200">
          ...
          <div class="mb-16 md:mb-24 text-center">
            <h2 class="mb-8 md:mb-14 text-5xl lg:text-6xl 2xl:text-7xl text-indigo-800 font-bold font-heading">Download Resources</h2>
              ...
              <dt class="text-lg">
                <button type="button" class="mb-20 flex w-full items-start justify-between text-left text-gray-400"
                  ...
                  <span class="ml-6 flex h-7 items-center">
                    <i class="transition translate hover:scale-110 duration-700 fas fa-download fa-2x text-indigo-800 hover:text-black"></i>
                  </span>
                </button>
